...
<section id="Concept" class="concept">
  <div class="concept__inner">
    ...
    <div class="concept__text__top">
      <p>Hair room Hacci（ヘアルーム ハッチ）は<br>
「お客様一人ひとりに寄り添いながら、お客様の求める美を叶えるサロン」<br>
を目指して日々成長しています。</p>
    </div>
    <div class="concept__text__bottom">
      <p>２席のみの小規模サロン。家族やカップルで貸切対応できます。（お早めのご予約で）<br>
小さいお子様連れ大歓迎、ベビーベットも完備。<br>
話題のTOKIOトリートメント、<br>
「美容ライト脱毛」「ライトフェイシャル」の機能を持つ脱毛器Lutella®を導入。<br>
代表は現在子育て中なので、少し平日の営業時間を短縮させて頂くことがございます。</p>
    </div>
  </div>
</section>
...
<section id="Menu" class="menu">
  <div class="menu__inner">
    ...
    <div class="menu__hair__container">
    ...
    <div class="menu__hair__container">
      <div class="menu__hair__box menu__hair__box__border">
        <div class="menu__hair__item">
          <div class="menu__hair__content">
            <div class="menu__hair__price">
              <p>エクステ</p>
